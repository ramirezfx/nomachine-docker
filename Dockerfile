...
COPY ./nomachine_6.11.2_1_amd64.deb /
...
RUN DEBIAN_FRONTEND=noninteractive \
    ...
    apt-get install -y /nomachine_6.11.2_1_amd64.deb xfonts-100dpi xfonts-100dpi-transcoded xfonts-75dpi xfonts-75dpi-transcoded  && \
